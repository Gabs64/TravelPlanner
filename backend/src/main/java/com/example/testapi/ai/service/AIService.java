...
public class AIService {
    ...
    public String generateChatResponse(List<ChatMessage> history, String userMessage, String apiKey) throws Exception {
        ...
        siParts.add(objectMapper.createObjectNode().put("text", 
            ...
            "Always include exact, accurate latitude and longitude coordinates for as many MAP tags as there are suggested places in your text. " +
    ...
    private String generateMockResponse(String userMessage) {
        ...
        if (msg.contains("boracay")) {
            return "🏝️ **Boracay** is world-famous for its powdery white sand beaches and incredible sunset views.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: White Beach Boracay | 11.9585, 121.9254], [MAP: Puka Shell Beach Boracay | 11.9961, 121.9161], [MAP: Diniwid Beach Boracay | 11.9740, 121.9168]";
            ...
            return "🌲 **Baguio City** (the Summer Capital of the Philippines) offers cool weather, pine trees, and fresh mountain breezes.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Burnham Park Baguio | 16.4116, 120.5932], [MAP: Mines View Park Baguio | 16.4234, 120.6276], [MAP: Camp John Hay Baguio | 16.3989, 120.6156]";
            ...
            return "🏙️ **Cebu** combines a bustling metropolis with pristine white-sand beaches, waterfalls, and rich heritage sites.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Temple of Leah | 10.3697, 123.8718], [MAP: Sirao Flower Garden | 10.4042, 123.8696], [MAP: Basilica del Sto. Niño | 10.2942, 123.9021], [MAP: House of Lechon | 10.3168, 123.9060]";
            ...
            return "🌊 **Palawan** is hailed as one of the most beautiful islands in the world, featuring towering limestone cliffs and crystal-clear lagoons.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: El Nido Big Lagoon | 11.1540, 119.4054], [MAP: Puerto Princesa Underground River | 10.1970, 118.9266], [MAP: Coron Kayangan Lake | 11.9566, 120.2267]";
            ...
            return "🏄‍♂️ **Siargao** is the Surfing Capital of the Philippines, featuring a laid-back, palm-fringed island vibe.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Cloud 9 Siargao | 9.8130, 126.1633], [MAP: Sugba Lagoon Siargao | 9.8660, 125.9863], [MAP: Maasin River | 9.8786, 126.0717]";
            ...
            return "🏛️ **Vigan City** is famous for its well-preserved Spanish-colonial streets, heritage sites, and cobblestone pathways.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Calle Crisologo Vigan | 17.5714, 120.3888], [MAP: Syquia Mansion Vigan | 17.5702, 120.3881], [MAP: Bantay Bell Tower Vigan | 17.5807, 120.3924]";
            ...
            return "🍫 **Bohol** offers beautiful beaches in Panglao, standard countryside landscapes, and unique biodiversity.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Chocolate Hills Bohol | 9.9167, 124.1667], [MAP: Tarsier Sanctuary Bohol | 9.6922, 124.0094], [MAP: Loboc River Cruise Bohol | 9.6385, 124.0322], [MAP: Panglao Island | 9.5786, 123.7744]";
            ...
            return "🌋 **Tagaytay** is a popular weekend retreat near Manila, offering cool weather and stunning views of Taal Volcano and Lake.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Taal Lake Tagaytay | 14.0102, 120.9976], [MAP: Picnic Grove Tagaytay | 14.1310, 120.9782], [MAP: Sky Ranch Tagaytay | 14.0957, 120.9361]";
            ...
            return "🗼 **Tokyo** is a dazzling metropolis combining futuristic skyscrapers, historic temples, and vibrant street life.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Sensoji Temple Tokyo | 35.7148, 139.7967], [MAP: Shibuya Crossing Tokyo | 35.6595, 139.7004], [MAP: Meiji Jingu Shrine Tokyo | 35.6764, 139.6993]";
            ...
            return "⛩️ **Kyoto** is the cultural heart of Japan, famous for thousands of classical temples, gardens, and traditional wooden houses.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Fushimi Inari Shrine Kyoto | 34.9671, 135.7727], [MAP: Kinkaku-ji Kyoto | 35.0394, 135.7292], [MAP: Arashiyama Bamboo Grove Kyoto | 35.0166, 135.6713]";
            ...
            return "🏛️ **Rome** is a city of historic ruins, monumental art, and vibrant street life.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Colosseum Rome | 41.8902, 12.4922], [MAP: Trevi Fountain Rome | 41.9009, 12.4833], [MAP: St. Peter's Basilica Rome | 41.9022, 12.4539]";
            ...
            return "🏝️ **Bali** is Indonesia's holiday island, known for its forested volcanic mountains, beaches, and coral reefs.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Ubud Monkey Forest Bali | -8.5194, 115.2606], [MAP: Tanah Lot Temple Bali | -8.6212, 115.0868], [MAP: Tegallalang Rice Terraces Bali | -8.4332, 115.2804]";
            ...
            return "🗼 **Paris** is a global center for art, fashion, gastronomy, and culture.\n\n" +
                    ...
                    "*Note: Since no API key is configured, I am running in local Demo Mode.* [MAP: Eiffel Tower Paris | 48.8584, 2.2945], [MAP: Louvre Museum Paris | 48.8606, 2.3376], [MAP: Notre-Dame Cathedral Paris | 48.8530, 2.3499]";
        } else {
            return "✈️ **Hello! I am your AI Travel Agent Suggester.**\n\n" +
                    ...
                    "*Note: No Gemini API Key is configured yet, so I am running in Demo Mode. You can configure your actual API Key in the Settings page!* [MAP: Manila Philippines | 14.5995, 120.9842]";
        }
    }
